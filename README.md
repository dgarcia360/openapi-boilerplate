...
On every new pull request, the OpenAPI document is linted with [Spectral](https://github.com/stoplightio/spectral). If there are changes that introduce errors, the workflow will fail and highlight them.
